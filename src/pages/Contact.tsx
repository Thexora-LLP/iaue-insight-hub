    ...
    <PageLayout
      ...
      <section className="max-w-6xl mx-auto py-16 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <form
            className="space-y-6 bg-white shadow-md rounded-2xl p-8 border-blue-600"
          >
          ...
          <aside className="bg-blue-50 rounded-2xl p-8 shadow-md border-blue-600 space-y-6">
