...
export const conferences = [
  {
    id: 1,
    title:
      "International Conference on Artificial Intelligence & Machine Learning 2024",
  ...
  },
  {
    ...
    rating: 4.6,
    description:
      "Explore the latest developments in sustainable engineering and environmental solutions.",
    topics: [
      "Green Technology",
      "Climate Change",
      "Renewable Energy",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "Discover breakthrough innovations in biomedical engineering and healthcare technology.",
  ...
  },
  {
    ...
    rating: 4.7,
    description:
      "Address the most pressing cybersecurity challenges in our digital age.",
  ...
  },
  {
    id: 5,
    title:
      "International Materials Science & Nanotechnology Conference",
    ...
    rating: 4.5,
    description:
      "Explore advances in materials science and nanotechnology applications.",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "Connect with data science leaders and explore the future of analytics.",
    topics: [
      "Big Data",
      "Analytics",
      "Data Visualization",
...
const Conferences = () => {
  ...
  const filteredConferences = conferences.filter((conference) => {
    const matchesSearch =
      ...
      conference.topics.some((topic) =>
        topic.toLowerCase().includes(searchTerm.toLowerCase())
      );
    const matchesType =
      typeFilter === "all" ||
      conference.type.toLowerCase() === typeFilter.toLowerCase();
    const matchesStatus =
      statusFilter === "all" ||
      conference.status.toLowerCase() === statusFilter.toLowerCase();
              ...
              <div className="flex gap-4">
                ...
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="call for papers">
                      Call for Papers
                    </SelectItem>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => navigate(`/view-details/${conference.id}`)}>
                      View Details
                    </Button>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(`/register-conference/${conference.id}`)
                      }>
                      Register
                    </Button>
                  </div>
